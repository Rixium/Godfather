...
@Suppress("unused")
object GodfatherModel : Ext(SolutionModel.Solution) {
    ...
    init {
        //setting(CSharp50Generator.Namespace, "ReSharperPlugin.Godfather.Rider.Model")
        //setting(Kotlin11Generator.Namespace, "com.jetbrains.rider.godfather.model")
